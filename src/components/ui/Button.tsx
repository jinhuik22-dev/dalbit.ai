...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-accent text-white hover:bg-accent-hover active:bg-accent-dark shadow-warm hover:shadow-warm-md hover:scale-[1.03] [box-shadow:0_0_20px_rgba(200,162,77,0.35)]",
  secondary:
