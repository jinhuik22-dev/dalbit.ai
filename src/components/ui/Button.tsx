...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-accent text-black hover:bg-accent-hover active:bg-accent-dark shadow-warm hover:shadow-warm-md hover:scale-[1.03] [box-shadow:0_0_20px_rgba(212,175,55,0.35)]",
  secondary:
