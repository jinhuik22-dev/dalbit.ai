...
<link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20120%20120%22%3E%3Cdefs%3E%3Cmask%20id%3D%22m%22%3E%3Crect%20width%3D%22120%22%20height%3D%22120%22%20fill%3D%22%23fff%22%2F%3E%3Ccircle%20cx%3D%2278%22%20cy%3D%2242%22%20r%3D%2234%22%20fill%3D%22%23000%22%2F%3E%3C%2Fmask%3E%3C%2Fdefs%3E%3Cg%20mask%3D%22url%28%23m%29%22%3E%3Ccircle%20cx%3D%2254%22%20cy%3D%2266%22%20r%3D%2240%22%20fill%3D%22%230A0A0A%22%2F%3E%3C%2Fg%3E%3Ccircle%20cx%3D%2290%22%20cy%3D%2226%22%20r%3D%229%22%20fill%3D%22%23E8380D%22%2F%3E%3C%2Fsvg%3E">
...
.wordmark svg{align-self:center;display:block;flex:none}
...
<nav>
  <div class="nav-inner">
    <a class="wordmark" href="#top"><svg width="28" height="28" viewBox="0 0 120 120" aria-hidden="true" focusable="false"><defs><mask id="moonCut"><rect width="120" height="120" fill="#fff"/><circle cx="78" cy="42" r="34" fill="#000"/></mask></defs><g mask="url(#moonCut)"><circle cx="54" cy="66" r="40" fill="currentColor"/></g><circle cx="90" cy="26" r="9" fill="#E8380D"/></svg>Dalbit <span class="hangul">달빛</span></a>
    <div class="nav-right">
      <div class="nav-links">
